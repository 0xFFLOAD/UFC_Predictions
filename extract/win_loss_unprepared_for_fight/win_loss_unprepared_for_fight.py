"""
Extraction logic for the "Win/Loss Unprepared for Fight" feature.

This feature is also tied to short-notice fights and the resulting
win/loss outcome.  There's no corresponding column in the large
set, so the extractor returns nothing.
"""
...
def extract():
    ...
    print("No columns for win/loss unprepared in dataset.")
