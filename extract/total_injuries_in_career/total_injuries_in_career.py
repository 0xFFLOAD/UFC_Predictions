"""
Extraction logic for the Total Injuries in Career feature.

This feature counts previous injuries; the large dataset does not
have an injury count column, so extraction will return empty.
"""
...
def extract():
    ...
    print("No injury-related columns found in dataset.")
