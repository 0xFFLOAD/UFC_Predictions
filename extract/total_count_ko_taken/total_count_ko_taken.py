"""
Extraction logic for the Total Count of KOs Taken feature.

The large dataset does not provide a column for KOs taken;
we'll return an empty frame with a message.
"""
...
def extract():
    ...
    print("No KO taken count column present in dataset.")
